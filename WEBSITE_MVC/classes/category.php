...
<?php
 class category
 {
    ...
    public function insert_category($catName){
        ...
        if(empty($catName)){
            $alert = "Thêm danh mục sản phẩm không thành công";
            return $alert;
        } else {
    ...
    public function  update_category($catName,$id){
        ...
        if(empty($catName)){
            $alert = "Chỉnh sửa danh mục sản phẩm không thành công";
            return $alert;
        } else {
            ...
            if($result){
                ...
                $alert = "<span class='error'>Chình sửa danh mục sản phẩm không thành công</span>";
                return $alert;
            }
        } 
    }
